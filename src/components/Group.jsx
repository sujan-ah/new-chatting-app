...
const Group = () => {
  ...
  return (
    ...
    >
      ...
      <button
        className="bg-primary text-white font-nunito font-bold text-md xl:text-lg rounded p-1 mt-5 mb-5 xl:ml-80"
        onClick={handleGroup}
      >
          ...
          <div className="flex justify-between mt-4 border-b pb-2.5 items-center">
            ...
            <div>
              <h1 className="font-nunito font-bold text-base">
                {item.groupname}{" "}
                <span className="font-nunito font-semibold text-[12px] sml:text-sm opacity-60">
