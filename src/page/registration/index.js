          ...
          <div className="w-[600px]">
            ...
            <div className="w-2/3">
              <div className="relative mt-14">
                <input
                  className="border border-solid border-purpal rounded-lg w-full px-14 py-7 border-opacity-30 font-nunito font-semibold text-2xl"
                  type="email"
                />
              ...
              <button className="w-full h-auto bg-primary p-6 rounded-full mt-12">
                <Link
                  to="/login"
                  className="font-nunito font-semibold text-white text-xl"
                >
                  Sign up
                </Link>
              </button>
